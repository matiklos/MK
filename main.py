...
def level_one():
    ...
    beams = [
        Beam(0, 690, 5000, 40),
        Beam(900, 600, 30, 120),
        Beam(1000, 550, 30, 300),
        Beam(1100, 550, 30, 300),
        Beam(1200, 500, 30, 300),
        Beam(1300, 450, 30, 300),
        Beam(1400, 400, 30, 300),
        Beam(1500, 600, 30, 120),
        Beam(1600, 550, 30, 300),
        Beam(1700, 550, 30, 300),
        Beam(1800, 500, 30, 300),
        Beam(1900, 450, 30, 300),
        Beam(2000, 400, 30, 300),
        Beam(2200, 600, 30, 120),
        Beam(2400, 550, 30, 300),
        Beam(2600, 550, 30, 300),
        Beam(2800, 500, 30, 300),
        Beam(3000, 450, 30, 300),
        Beam(3200, 600, 30, 120),
        Beam(3400, 550, 30, 300),
        Beam(3600, 550, 30, 300),
        Beam(3800, 500, 30, 300),
        Beam(4000, 450, 30, 300),
        Beam(4200, 350, 30, 400),
