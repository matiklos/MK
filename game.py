...
class Player(Physic, Health):
    def __init__(self):
        self.stand_right_img = pygame.image.load('Ninja/stand.png')  # normalna grafika
        self.stand_left_img = pygame.transform.flip(pygame.image.load('Ninja/stand.png'), True, False)
        ...
        self.jump_right_img = pygame.image.load('Ninja/jump.png')  # grafika skoku
        self.jump_left_img = pygame.transform.flip(pygame.image.load('Ninja/jump.png'), True, False)  # grafika skoku
        self.walk_right_img = [pygame.image.load(f'Ninja/walk/klatka0{x}.png') for x in
                               range(1, 7)]  # animacja chodzenia
        self.walk_left_img = [pygame.transform.flip(pygame.image.load(f'Ninja/walk/klatka0{x}.png'), True, False) for x
